...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<div class="container">
		...
		<form:form action="/admin/pd/s" method="post" commandName="product"
			...
			<div class="form-group">
				...
				<c:forEach items="${categoryList}" var="category">
					<c:if
						test="${category.categoryId eq product.productCategory.categoryId}">
						<label class="checkbox-inline"> <form:radiobutton
								path="productCategory" checked="checked" value="${category}" />
							${category.mainCategoryName} - ${category.subCategoryName}
						</label>
					</c:if>
					<c:if
						test="${category.categoryId ne product.productCategory.categoryId}">
						<label class="checkbox-inline"> <form:radiobutton
								path="productCategory" value="${category}" />
							${category.mainCategoryName} - ${category.subCategoryName}
						</label>
					</c:if>
				</c:forEach>
			...
			<div class="form-group">
				<label for="productSummary">Summary</label><br>
				<form:errors path="productSummary" cssStyle="color: red" />
				<form:input path="productSummary" id="productSummary"
					class="form-Control" />
			</div>
			...
			<div class="form-group">
				...
				<form:input type="Number" step="0.01" path="productPrice" id="price"
