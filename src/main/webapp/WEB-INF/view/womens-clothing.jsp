...
<section id="aa-catg-head-banner">
	<img
		src="<spring:url value="/resources/img/fashion/fashion-header-bg-8.jpg" />"
		alt="fashion img">
...
<!-- product category -->
<section id="aa-product-category" ng-app="cartApp"
					...
					<div class="aa-product-catg-head">
						<div class="aa-product-catg-head-left">
							...
							<form action="" class="aa-show-form">
								<label for="">Show</label> <select id="numberShows">
									<option>6</option>
									<option>9</option>
									<option>12</option>
								</select>
									...
									<li>
										<figure>
											<a class="aa-product-img"
												href="<c:url value="/products/viewProduct/${product.productId}" />">
												<img style="width: 250px; height: 300px"
												src="<c:url value="/resources/images/${product.productId}/0.png" />"
												alt="polo shirt img">
											</a>
											...
											<figcaption>
												...
												<span class="aa-product-price">$${product.productPrice}</span><span
													class="aa-product-price"><del>$9999</del></span> <span
					...
					<div class="aa-product-catg-pagination">
						<nav>
							<ul class="pagination">
								<c:if test="${page gt 1}">
									<li><a
										href="<my:replaceParam name='p' value='${page-1}' />"
								...
								<c:forEach begin="1" end="${pageTotal}" varStatus="loop">
									<c:if test="${count eq page}">
										<li><a style="background-color: #ff6666; color: white;"
											href="<my:replaceParam name='p' value='${count}' />">${count}
										</a></li>
									</c:if>
									<c:if test="${count ne page}">
										<li><a
											href="<my:replaceParam name='p' value='${count}' />">${count}</a>
										</li>
									</c:if>
				...
				<aside class="aa-sidebar">
					...
					<div class="aa-sidebar-widget">
						...
						<ul class="aa-catg-nav">
							<li><a
								href="<my:replaceParam name='c' value='activewear' />">Activewear</a></li>
							<li><a href="<my:replaceParam name='c' value='jeans' />">Jeans</a></li>
							<li><a
								href="<my:replaceParam name='c' value='shirtdress' />">Shirtdress</a></li>
					...
					<div class="aa-sidebar-widget">
						...
						<div class="tag-cloud">
							...
							<a href="<my:replaceParam name='t' value='jeans' />">Jeans</a> <a
								href="<my:replaceParam name='t' value='shirtdress' />">Shirtdress</a>
						...
						<div class="aa-sidebar-price-range">
							<div>
								...
								<br> <input id="skip-value-lower" class="aa-filter-btn"
									...
									value="30" type="button" /> <input id="skip-value-upper"
									class="aa-filter-btn"
									style="background-color: white; color: black; text-align: center; cursor: default"
									value="100" type="button" /> <a href="#"><button
										class="aa-filter-btn" type="submit">Filter</button></a>
							</div>
						</div>
