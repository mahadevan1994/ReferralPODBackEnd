									...
									<c:forEach items="${productPopular}" var="product">
										<li>
											<figure>
												...
												<figcaption>
													<h4 class="aa-product-title">
														<a href="<c:url value="/pd/p?id=${product.productId}" />">${product.productName}</a>
													</h4>
													<span class="aa-product-price">$${product.productPrice}</span><span
														class="aa-product-price"><del>$999</del></span>
												</figcaption>
			...
			<div class="col-md-12">
				<div class="aa-client-brand-area">
					<ul class="aa-client-brand-slider">
						<li><a href="#"><img
								src="<c:url value="img/client-brand-java.png" />" alt="java img"></a></li>
						<li><a href="#"><img
								src="<c:url value="img/client-brand-jquery.png" />"
								alt="jquery img"></a></li>
						<li><a href="#"><img
								src="<c:url value="img/client-brand-html5.png" />"
								alt="html5 img"></a></li>
						<li><a href="#"><img
								src="<c:url value="img/client-brand-css3.png" />" alt="css3 img"></a></li>
						<li><a href="#"><img
								src="<c:url value="img/client-brand-wordpress.png" />"
								alt="wordPress img"></a></li>
						<li><a href="#"><img
								src="<c:url value="img/client-brand-joomla.png" />"
								alt="joomla img"></a></li>
						<li><a href="#"><img
								src="<c:url value="img/client-brand-css3.png" />" alt="css3 img"></a></li>
						<li><a href="#"><img
