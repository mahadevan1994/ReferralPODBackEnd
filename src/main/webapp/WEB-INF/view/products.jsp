					...
					<div class="aa-product-catg-head">
						<div class="aa-product-catg-head-left">
							<form action="" class="aa-sort-form">
								<label for="">Sort by</label> <select onchange="sortBy(this)">
									<option selected>Default</option>
									<option value="<my:replaceParam name='st' value='0' />">Price
										Ascending</option>
									<option value="<my:replaceParam name='st' value='1' />">Price
										Descending</option>
								</select>
							</form>
							<form action="" class="aa-show-form">
								<label for="numberShows">Show</label> <select id="numberShows"
									onchange="rePagination(${products.size()})">
									<option>3</option>
				...
				<aside class="aa-sidebar">
					...
					<div class="aa-sidebar-widget">
						...
						<div class="aa-sidebar-price-range">
							<input type="radio" name="priceRage" max="20"
								onclick="PriceRangeRadio(this,'<my:replaceParam name='lp' value='0' />');">$0
							- $20<br> <input type="radio" name="priceRage" max="40"
								onclick="PriceRangeRadio(this,'<my:replaceParam name='lp' value='20' />');">$20
							- $40<br> <input type="radio" name="priceRage" max="60"
								onclick="PriceRangeRadio(this,'<my:replaceParam name='lp' value='40' />');">$40
