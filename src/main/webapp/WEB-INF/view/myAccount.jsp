				...
				<div ng-controller="overViewsCtrl">
					...
					<div id="email">${customer.email}
						<c:if test="${unAuth ne null}">
							...
							<button class="btn btn-primary" ng-click="reSendActiveCode()"
								ng-disabled="reSendDisabled">ReSend</button>
						</c:if>
					</div>
								...
								<div class="panel-body">
									<div style="width: 80%; float: left">
										<c:forEach var="orderItem"
											items="${customerOrder.getCustomerOrderItems()}">
											<div class="row">
												<div class="col-md-5 col-sm-5 col-xs-12">
													<img style="width: 150px; height: 150px"
														src="<c:url value="/images/${orderItem.productId}/0.png" />"
													...
													<div class="aa-product-view-content">
														...
														<div class="aa-price-block">
															<span class="aa-product-view-price">Quantity:
																${orderItem.productQuantity}</span><br> <span
																class="aa-product-view-price">Total:
