...
<c:if test="${not empty referralLinkError}">
	<div
		style="font-size: 3rem; font-weight: bold; color: red; text-align: center">${referralLinkError}</div>
</c:if>
<c:if test="${not empty referralLinkSuccess}">
	<div
		style="font-size: 3rem; font-weight: bold; color: green; text-align: center">${referralLinkSuccess}</div>
</c:if>
<!-- / slider -->
<!-- Start Promo section -->
<section id="aa-promo">
							...
							<div class="aa-promo-left">
								<div class="aa-promo-banner">
									<img style="object-fit: cover;"
										src="../img/for-women-450x450.jpg" alt="img">
						...
						<div class="col-md-7 no-padding">
							<div class="aa-promo-right">
								<div class="aa-single-promo-right">
									<div class="aa-promo-banner">
										<img style="object-fit: cover;"
											src="../img/for-men-300x220.jpg" alt="img">
										<div class="aa-prom-content">
