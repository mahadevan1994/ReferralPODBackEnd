...
public class ReferralMarketingUserReferralConfigController {
	...
	public String userReferralManagement(Model model) {
		...
		if (referralMarketingUserReferralConfigService.findFirst() != null) {
			userReferralConfigItem = referralMarketingUserReferralConfigService.findFirst();
		}
	...
	public String addUserReferralConfig(
			@Valid @ModelAttribute("userReferral") ReferralMarketingUserReferralConfigItem referralMarketingUserReferralConfigItem,
			BindingResult result, Model model) {
		if (result.hasErrors()) {
			return "admin/referralMarketingUserReferralConfig";
		}
		referralMarketingUserReferralConfigService.save(referralMarketingUserReferralConfigItem);
		model.addAttribute("userReferral", referralMarketingUserReferralConfigItem);
